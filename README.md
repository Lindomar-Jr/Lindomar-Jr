...
Acredito que dominar os fundamentos é essencial para criar soluções com clareza, qualidade e propósito. Por isso, busco compreender cada tecnologia em profundidade antes de avançar para novos desafios, construindo uma base sólida para evoluir de forma consistente.

---

## Sobre mim

Tenho 24 anos, moro no interior do Rio de Janeiro, em Nova Friburgo. Sou estudante de Análise e Desenvolvimento de Sistemas, com foco em desenvolvimento web full stack. Minha abordagem de estudo é prática e orientada à construção de conhecimento: realizo exercícios, desafios e pequenos projetos que consolidam cada aprendizado.
...
- Desenvolver projetos cada vez mais completos e relevantes.
- Documentar minha evolução e compartilhar conhecimento por meio do GitHub.
